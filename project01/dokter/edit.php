...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE pasien SET nama = ?,  gender = ?, tmp_lahir = ?, tgl_lahir = ?,  kategori = ?, telpon = ?, alamat = ?, unit_kerja_id = ? WHERE id = ?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="edit.php?id=<?= $row['id'] ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="kelurahan_id" class="col-4 col-form-label">Unit_kerja ID</label>
                                    <div class="col-8">
